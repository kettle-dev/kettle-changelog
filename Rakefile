...
# kettle-changelog Rakefile v7.1.1 - 2026-08-09
...
# rake install                                # Build and install kettle-changelog-1.0.0.gem in...
# rake install:local                          # Build and install kettle-changelog-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template kettle-changelog against itse...
