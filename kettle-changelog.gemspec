...
Gem::Specification.new do |spec|
  spec.name = "kettle-changelog"
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/kettle/changelog/version.rb", mod) }::Kettle::Changelog::Version::VERSION
  ...
  spec.metadata["homepage_uri"] = "https://kettle-changelog.galtzo.com"
  ...
  spec.add_dependency("kettle-dev", ">= 3.0.11", "< 4.0.0")                       # ruby >= 2.4.0
